...
def main():
    """
    Main function to run the Monopoly board application.
    """
    # Initialize pygame
    pygame.init()
    ...
    # Get the center coordinates of each space
    space_centers = board.get_space_centers()
    
    # Print the first few center coordinates as a demonstration
    print("Center coordinates of the first 5 spaces:")
    for i in range(5):
        print(f"Space {i}: {space_centers[i]}")
