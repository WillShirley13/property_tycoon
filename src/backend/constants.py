...
PROPERTY_DATA = {
    ...
    "The Old Creek": {
        ...
        "png_name": "old_creek.png",
    },
    "Gangsters Paradise": {
        "cost": 60,
        "rents": [4, 20, 60, 180, 320, 450],
        "png_name": "gangsters_paradise.png",
    },
    # Blue Properties
    "The Angels Delight": {
        "cost": 100,
        "rents": [6, 30, 90, 270, 400, 550],
        "png_name": "angels_delight.png",
    },
    "Potter Avenue": {
        "cost": 100,
        "rents": [6, 30, 90, 270, 400, 550],
        "png_name": "potters_avenue.png",
    },
    "Granger Drive": {
        "cost": 120,
        "rents": [8, 40, 100, 300, 450, 600],
        "png_name": "grangers_drive.png",
    },
    # Purple Properties
    "Skywalker Drive": {
        "cost": 140,
        "rents": [10, 50, 150, 450, 625, 750],
        "png_name": "skywalker_drive.png",
    },
    "Wookie Hole": {
        "cost": 140,
        "rents": [10, 50, 150, 450, 625, 750],
        "png_name": "wookie_hole.png",
    },
    "Rey Lane": {
        "cost": 160,
        "rents": [12, 60, 180, 500, 700, 900],
        "png_name": "rey_lane.png",
    },
    # Orange Properties
    "Bishop Drive": {
        "cost": 180,
        "rents": [14, 70, 200, 550, 750, 950],
        "png_name": "bishop_drive.png",
    },
    "Dunham Street": {
        "cost": 180,
        "rents": [14, 70, 200, 550, 750, 950],
        "png_name": "dunham_street.png",
    },
    "Broyles Lane": {
        "cost": 200,
        "rents": [16, 80, 220, 600, 800, 1000],
        "png_name": "broyles_lane.png",
    },
    # Red Properties
    "Yue Fei Square": {
        "cost": 220,
        "rents": [18, 90, 250, 700, 875, 1050],
        "png_name": "yue_fei_square.png",
    },
    "Mulan Rouge": {
        "cost": 220,
        "rents": [18, 90, 250, 700, 875, 1050],
        "png_name": "mulan_rouge.png",
    },
    "Han Xin Gardens": {
        "cost": 240,
        "rents": [20, 100, 300, 750, 925, 1100],
        "png_name": "han_xin_gardens.png",
    },
    # Yellow Properties
    "Shatner Close": {
        "cost": 260,
        "rents": [22, 110, 330, 800, 975, 1150],
        "png_name": "shatner_close.png",
    },
    "Picard Avenue": {
        "cost": 260,
        "rents": [22, 110, 330, 800, 975, 1150],
        "png_name": "picard_avenue.png",
    },
    "Crusher Creek": {
        "cost": 280,
        "rents": [22, 120, 360, 850, 1025, 1200],
        "png_name": "crusher_creek.png",
    },
    # Green Properties
    "Sirat Mews": {
        "cost": 300,
        "rents": [26, 130, 390, 900, 1100, 1275],
        "png_name": "sirat_mews.png",
    },
    "Ghengis Crescent": {
        "cost": 300,
        "rents": [26, 130, 390, 900, 1100, 1275],
        "png_name": "ghengis_crescent.png",
    },
    "Ibis Close": {
        "cost": 320,
        "rents": [28, 150, 450, 1000, 1200, 1400],
        "png_name": "ibis_close.png",
    },
    # Deep Blue Properties
    "James Webb Way": {
        "cost": 350,
        "rents": [35, 175, 500, 1100, 1300, 1500],
        "png_name": "james_webb_way.png",
    },
    "Turing Heights": {
        "cost": 400,
        "rents": [50, 200, 600, 1400, 1700, 2000],
        "png_name": "turing_heights.png",
    },
    # Stations
    "Brighton Station": {
        "cost": 200,
        "rents": [25, 50, 100, 200],
        "png_name": "brighton_station.png",
    },  # rents based on number of stations owned
    "Hove Station": {
        "cost": 200,
        "rents": [25, 50, 100, 200],
        "png_name": "hove_station.png",
    },
    "Falmer Station": {
        "cost": 200,
        "rents": [25, 50, 100, 200],
        "png_name": "falmer_station.png",
    },
    "Portslade Station": {
        "cost": 200,
        "rents": [25, 50, 100, 200],
        "png_name": "portslade_station.png",
    },
    # Utilities
    "Tesla Power Co": {
        "cost": 150,
        "rents": [4, 10],
        "png_name": "tesla_power_co.png",
    },  # multipliers for 1 or 2 utilities owned
    "Edison Water": {"cost": 150, "rents": [4, 10], "png_name": "edison_water.png"},
}
