...
class CurrentPlayerDisplay:
    ...
    def draw(self, current_player: Optional[Player]) -> None:
        ...
        pygame.draw.rect(self.screen, self.HIGHLIGHT_COLOR, name_bg_rect, 2, border_radius=8)
        ...
        pygame.draw.rect(self.screen, (200, 230, 200), balance_bg_rect, 1, border_radius=5)
