...
class FreeParkingPopup:
    # Initialize the popup for when a player lands on the Free Parking space
    ...
    # Draw the Free Parking popup with player information and collected fines
    def draw(self, player: Player, amount: int = 0) -> None:
        ...
        # Draw the title (player landed on Free Parking)
        ...
        # Draw explanation text with the amount of fines collected
    ...
    # Process user input events and detect button clicks
    ...
    def show(self, player: Player, amount: int = 0) -> str:
