...
class BankruptPopup:
    ...
    def draw(self, player: Player) -> None:
        ...
        # Draw the title
        title_text: str = f"{player.get_name()} is bankrupt!"
        ...
        info_text: str = f"{player.get_name()} has been removed from the game."
    ...
    # Handle events for the bankruptcy popup
