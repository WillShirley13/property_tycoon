...
class JailVisitPopup:
    # Initialize the popup for when a player is just visiting the jail space
    ...
    # Draw the jail visit popup with player information and message
    def draw(self, player: Player) -> None:
        ...
        # Draw the title (player visiting jail)
