...
class GoPopup:
    # Initialize the popup for when a player lands on the GO space
    ...
    # Draw the GO popup with player information and collect money message
    def draw(self, player: Player) -> None:
        ...
        # Draw the title (player landed on Go)
        title_text: str = f"{player.get_name()} landed on Go!"
        ...
        info_text: str = "Collect £200 as you pass Go!"
    ...
    # Draw a button with specified properties and hover effect
    def draw_button(
