...
class StartScreenDisplay:
    def __init__(self, screen_width: int, screen_height: int):
        ...
        self.BUTTON_HOVER_COLOR: Tuple[int, int, int] = (90, 150, 90)  # Lighter green for hover
    ...
    def display(self, screen: pygame.Surface) -> List[str]:
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        # Draw subtitle
        subtitle_surface: pygame.Surface = self.subtitle_font.render("Enter player names (1-5 players)", True, self.TEXT_COLOR)
        ...
        for i, box in enumerate(self.input_boxes):
            ...
            label_surface: pygame.Surface = self.input_font.render(label_text, True, self.TEXT_COLOR)
