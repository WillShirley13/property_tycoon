...
class TimeLimitChoiceDisplay:
    def __init__(self, screen_width: int, screen_height: int) -> None:
        ...
        # Define color scheme
        self.BACKGROUND_COLOR: Tuple[int, int, int] = (240, 240, 240)  # Light gray background
        self.BUTTON_COLOR: Tuple[int, int, int] = (70, 130, 70)        # Green for button
        self.BUTTON_HOVER_COLOR: Tuple[int, int, int] = (90, 150, 90)  # Lighter green for hover state
        self.BUTTON_INACTIVE_COLOR: Tuple[int, int, int] = (150, 150, 150)  # Gray for inactive buttons
    ...
    def display(self, screen: pygame.Surface) -> int:
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        title_surface: pygame.Surface = self.title_font.render(title_text, True, (0, 0, 0))
        ...
        for button, time in self.buttons:
            ...
            pygame.draw.rect(screen, (30, 100, 30), button, 2, border_radius=10)  # Add border
